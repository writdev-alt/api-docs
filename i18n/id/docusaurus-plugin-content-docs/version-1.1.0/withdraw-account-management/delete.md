...
Hapus akun penarikan. Hanya akun milik pengguna yang terautentikasi yang dapat dihapus.
...
|-----------|---------|-------|-----------------------------------|
| `id`      | integer | ✅    | ID akun penarikan yang akan dihapus. |
...
> **⚠️ Peringatan**  
> Tindakan ini bersifat permanen dan tidak dapat dibatalkan. Pastikan Anda ingin menghapus akun ini sebelum melanjutkan.
